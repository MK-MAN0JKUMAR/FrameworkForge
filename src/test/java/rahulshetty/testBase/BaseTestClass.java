...
public class BaseTestClass {
	...
	public void setup(String os, String br) throws IOException {
		...
		case "firefox":
			...
			fireOptions.addPreference("dom.webdriver.enabled", false); // Disable automation banner
			fireOptions.addPreference("useAutomationExtension", false); // Disable automation extension
